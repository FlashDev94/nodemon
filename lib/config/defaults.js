...
const defaults = {
  ...
  verbose: false,
  signal: 'SIGUSR2',
  // When > 0: after sending the normal stop/restart signal, if the child is
  // still alive after this many ms, force-kill with SIGKILL. 0 / unset = off
  // (historical behavior: wait indefinitely for a graceful exit).
  killTimeout: 0,
